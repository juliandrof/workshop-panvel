...
# MAGIC %md
# MAGIC # Workshop Panvel - Pipeline DLT (Versão Exercício)
# MAGIC
# MAGIC Complete os TO-DOs para construir seu pipeline Delta Live Tables!
# MAGIC
...
#       Use o decorator @dlt.table com name="bronze_produtos"
#       Não esqueça de definir o schema como {catalog_name}.bronze
