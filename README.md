...
```
  ...
  │────────────────│     ╠══════════════════╣     ╠══════════════════╣     ╠══════════════════╣     ╠══════════════════╣
  │                │     ║                  ║     ║                  ║     ║                  ║     ║                  ║
  │  JSON Vendas   │────▶║  Auto Loader     ║────▶║  Limpeza &      ║────▶║  Agregacoes      ║────▶║  Genie (NL)      ║
  │  Streaming     │     ║  Ingestao        ║     ║  Validacao       ║     ║  por Categoria   ║     ║  AI/BI Dashboard ║
  │  Tempo Real    │     ║  Continua        ║     ║                  ║     ║                  ║     ║                  ║
  │                │     ║                  ║     ║  Enriquecimento  ║     ║  KPIs &          ║     ║  Segmentacao     ║
  │  ~120 lojas    │     ║  Raw Data        ║     ║  com Dados       ║     ║  Metricas de     ║     ║  de Clientes     ║
  │  1 JSON/20s    │     ║  Sem Trans-      ║     ║  Cadastrais      ║     ║  Vendas          ║     ║  RFM + K-Means   ║
  │                │     ║  formacao        ║     ║                  ║     ║                  ║     ║                  ║
  │                │     ║                  ║     ║  Extracao        ║     ║  Rankings        ║     ║  MLflow Track-   ║
